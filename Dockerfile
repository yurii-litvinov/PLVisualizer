...
COPY ["PLVisualizer.BusinessLogic/Clients/DocxClient/WorkingPlans", "/app/publish/PLVisualizer.BusinessLogic/Clients/DocxClient/WorkingPlans"]
...
RUN dotnet publish "PLVisualizer.Api.csproj" -c Release -o /app/publish
