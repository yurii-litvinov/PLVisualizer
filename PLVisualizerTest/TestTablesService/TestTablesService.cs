    ...
    private static object[] getLecturersViaConfigTestCases =
    {
        new object[] { severalConfigLecturersSheetTitle, largeFileXlsxPath,
            new Lecturer[]
            {
                ...
                new ()
                {
                    Name = "Кириленко Яков Александрович", Standard = 700,DistributedLoad = 46,InterestRate = 50, Post = "старший преподаватель",
            ...
            severalLecturersSheetTitle, new Lecturer[]
            {
                ...
                new()
                {
                    ...
                    DistributedLoad = 46, Standard = 700, Disciplines = new List<Discipline>()
                    {
                        new()
                        {
                            Code = "002187", ContactLoad = 32, HasPracticesHours = true,
                            Content =
                        ...
                        new()
                        {
                            Code = "064851", ContactLoad = 14,Terms = "4", HasPracticesHours = false,
